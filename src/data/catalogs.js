...
export const CATALOGS = [
  ...
  },
  {
    ...
    brand: 'Demanti',
    brandKey: 'demanti',
    title: 'Demanti Tilebook 2026',
    country: 'venezuela',
    file: '/catalogs/venezuela/demanti-2026.pdf',
    category: 'tiles',
    cover: '/images/catalogs/demanti-2026.png',
    keywords: [
      'demanti',
      'tilebook',
      'porcelanico',
  ...
  },
  {
    slug: 'grupo-stone',
    brand: 'Grupo Stone',
    brandKey: 'grupo-stone',
    title: 'Grupo Stone — Colección 2026–2027',
    country: 'venezuela',
    file: '/catalogs/venezuela/grupo-stone.pdf',
    category: 'tiles',
    cover: '/images/catalogs/grupo-stone.png',
    keywords: [
      'grupo stone',
      'stone',
      'piedra',
  ...
  },
  {
    ...
    brand: 'Neolith',
    brandKey: 'neolith',
    title: 'Neolith Gallery 2026',
    country: 'venezuela',
    file: '/catalogs/venezuela/neolith-2026.pdf',
    category: 'tiles',
    cover: '/images/catalogs/neolith-2026.png',
    keywords: [
      'neolith',
      'gallery',
      'disponibilidad',
  ...
  },
  {
    ...
    title: 'Polished Sale',
    country: 'venezuela',
    file: '/catalogs/venezuela/polished-sale.pdf',
    category: 'tiles',
    cover: '/images/catalogs/polished-sale.png',
    keywords: [
      'polished',
      'polished sale',
      'pulido',
  ...
  },
  {
    ...
    brand: 'Amalfi Tiles',
    brandKey: 'amalfi',
    title: 'Amalfi Tiles — Colección 2026–2027',
    country: 'venezuela',
    file: '/catalogs/venezuela/amalfi-2026.pdf',
    category: 'tiles',
    cover: '/images/catalogs/amalfi-2026.png',
    keywords: [
      'amalfi',
      'amalfi tiles',
      'grupo stone',
  ...
  },
  {
    ...
    brand: 'Zenon',
    brandKey: 'zenon',
    title: 'Zenon SPC — Accesorios y piezas especiales',
    country: 'venezuela',
    file: '/catalogs/venezuela/spc-accesorios.pdf',
    category: 'tiles',
    cover: '/images/catalogs/spc-accesorios.png',
    keywords: [
      'zenon',
      'spc',
      'vinilo',
