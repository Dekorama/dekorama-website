...
export default function MarketGate() {
  ...
  return (
    <div
      ...
      className={`fixed inset-0 z-[100] flex flex-col overflow-hidden bg-white text-gray-900 transition-opacity duration-300 ${
        leaving ? 'opacity-0' : 'opacity-100'
      }`}
    >
      <header className="relative z-20 flex shrink-0 items-center justify-between border-b border-gray-200 px-5 py-3.5 sm:px-8 sm:py-4">
        <Image
      ...
      <div className="relative z-10 flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-contain">
        <div className="shrink-0 px-5 pb-6 pt-8 text-center sm:px-8 sm:pb-8 sm:pt-12">
          ...
          {markets.map((market) => {
            ...
            return (
              <button
                ...
                className={`group relative flex min-h-[42svh] flex-col items-center justify-center overflow-hidden text-center text-white transition-opacity duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-white md:min-h-0 ${
