    ...
    <section id="contacto" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-bg">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-8 border-t border-gray-300">
          ...
          <a href="tel:+34628571537" className="flex items-center gap-3 text-gray-700 hover:text-black focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 rounded-full transition-colors">
