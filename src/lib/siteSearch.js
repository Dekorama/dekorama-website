...
const KEYWORDS = {
  ...
  catalog: ['catalogo', 'catálogo', 'catalogue', 'catalog'],
...
export const CATALOG_SEARCH_KEYWORDS = {
  tiles: ['porcelanico', 'porcelánico', 'tile', 'tiles', 'porcelain', 'suelo', 'revestimiento'],
  taps: ['griferia', 'grifería', 'grifo', 'tap', 'taps', 'faucet'],
  sanitaryware: ['sanitario', 'inodoro', 'toilet', 'wc'],
  lighting: ['iluminacion', 'iluminación', 'light', 'lighting', 'lamp'],
  bathroom: ['baño', 'bano', 'bathroom', 'mobiliario'],
