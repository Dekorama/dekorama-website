  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: locale === 'es' ? 'Reformas Torremolinos' : 'Renovations Torremolinos',
        item: `${baseUrl}/${locale}/reformas-torremolinos`,
      },
    ],
  }
          ...
          <div className="max-w-7xl mx-auto">
            <nav className="text-sm text-gray-500 mb-8">
              ...
              <span className="text-black font-medium">
                {locale === 'es' ? 'Reformas Torremolinos' : 'Renovations Torremolinos'}
              </span>
            </nav>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden">
                <Image
                  src={images.services.reformas}
                  alt="Reformas integrales Torremolinos - Dekorama"
                  fill
